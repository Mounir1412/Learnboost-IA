...
require_once dirname(__DIR__, 2) . '/../controllers/CourseController.php';
require_once dirname(__DIR__, 2) . '/../controllers/ModuleController.php';
require_once dirname(__DIR__, 2) . '/../controllers/LessonController.php';
