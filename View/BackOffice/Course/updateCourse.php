...
if (isset($_POST["title"]) && isset($_POST["description"]) && isset($_POST["status"])) {
    ...
    if (
        ...
        $error = "Tous les champs sont obligatoires. (Titre min 3 caractères, description min 10 caractères)";
    }
}
?>
    ...
    <div class="page-header">
        ...
        <p class="page-sub-title">Mettez à jour les informations du cours</p>
    </div>
